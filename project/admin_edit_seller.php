...
if (isset($_POST['update'])) {
    ...
    if (!$result) {
        ...
        header('location: admin_sellers.php'); // Redirect to the sellers list page
    }
}

// Fetch the seller information based on the S_Id parameter
if (isset($_GET['S_Id'])) {
    $S_Id = $_GET['S_Id'];
    ...
    if ($result->num_rows == 1) {
        ...
        include('admin_edit_seller_form.php');
    } else {
