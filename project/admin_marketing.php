...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO `Marketing` (`M_Name`, `P_Id`, `A_Id`) 
          VALUES ('$M_Name', '$P_Id', '$A_Id')";
    ...
    if (!$result) {
        ...
        header('location: admin_marketing.php'); // Redirect to a success page if needed
}
}
      ...
      <?php if (isset($message)) : ?>
        ...
        <?php endif; ?>
         <div class="flex">
            <div class="box">
               <p>Marketing Name *</p>
               <input type="text" name="M_Name" required maxlength="50" placeholder="Marketing Name" class="input">
            </div>
            <div class="box">
               <p>Property ID</p>
...
<section class="">
    ...
    <?php
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<table border='1'>";
            echo "<tr><th> Marketing ID </th><th> Marketing Name </th><th> Property ID </th><th> Agent ID </th></tr>";
