...
if (isset($_POST['submit'])) {
    ...
    $Sale_Description = mysqli_real_escape_string($conn, $_POST['Sale_Description']);
    $P_Id = mysqli_real_escape_string($conn, $_POST['P_Id']);
    $A_Id = mysqli_real_escape_string($conn, $_POST['A_Id']);

    // Insert property details into the database
    $query = "INSERT INTO `Seller` (`First_Name`, `Last_Name`, `Email`, `Phone_Number`, `Sale_Description`, `P_Id`, `A_Id`) 
          VALUES ('$First_Name', '$Last_Name', '$Email', '$Phone_Number', '$Sale_Description', '$P_Id', '$A_Id')";
    ...
    if (!$result) {
        ...
        header('location: admin_sellers.php'); // Redirect to a success page if needed
}
}
        ...
        <?php endif; ?>
         <div class="flex">
            ...
            <div class="box">
               ...
               <input type="text" name="Sale_Description" maxlength="50" placeholder="Enter the Preferences" class="input">
            </div>
            <div class="box">
               <p>Property ID</p>
...
<section class="">
    ...
    <?php
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<table border='1'>";
            echo "<tr><th> Seller ID </th><th> First Name </th><th> Last Name </th><th> Email </th><th> Phone Number </th><th> Sale Description </th><th> Property ID </th><th> Agent ID </th></tr>";
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td>" . $row["Sale_Description"] . "</td>";
                echo "<td>" . $row["P_Id"] . "</td>";
                echo "<td>" . $row["A_Id"] . "</td>";
                echo "<td><a href='admin_edit_seller.php?S_Id=" . $row["S_Id"] . "'>Edit</a></td>";
                echo "</tr>";
            }
            echo "</table>";
        } else {
