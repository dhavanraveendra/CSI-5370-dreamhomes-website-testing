...
if (isset($_POST['update'])) {
    ...
    // Update the buyer information in the database
    ...
    if (!$result) {
        ...
        header('location: admin_buyers.php'); // Redirect to the buyers list page
    }
}

// Fetch the buyer information based on the B_ID parameter
if (isset($_GET['B_ID'])) {
    $B_ID = $_GET['B_ID'];
    ...
    if ($result->num_rows == 1) {
        ...
        include('admin_edit_buyer_form.php');
